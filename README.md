...
# Rick Smith Portfolio Project - Web 2890

This is the primary assignment for the WEB 2890 course, which will serve as a professional website to showcase selected work and projects. Includes the following:

- Landing/Home Section
- 6 portfoio gallery/thumbnails
- 6 project descriptions
- One case study
- An About Me Section
- A Contact Section

Deployed at the following Netlify link:

https://ricksmith.netlify.app/
